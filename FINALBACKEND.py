...
def mainfun():
    ...
    tlabel=Label(Tops,text="MISHRA'S COURIER SERVICE SYSTEM",font=('arial',25,'bold'),bd=20,width=70,fg="black",bg="cornflower blue")
    ...
    #=====================2ND PAGE CODE================================================================================================
    def newfun():
        if(e7.get() == "171B162" and e8.get() == "arushi"):
            messagebox.showinfo("CONGRATULATION","YOU ARE SUCCESSFULLY LOGGED IN")
            root.destroy()
            r2=Tk()
            import time;
            localtime=time.asctime(time.localtime(time.time()))
    ...
    #=======================4TH page fun...==========================================================================================
            ...
            def fnnn():
                ...
                Bottoms.pack(side=BOTTOM)
                label1=Label(Tops,text="MISHRA'S COURIER SERVICE SYSTEM",bg="light pink",bd=10,font=('times',30,'bold'), fg="black" ,width=60)
                label1.pack()
    ...
    #=====================5TH PAGE CODE=================================================================================================            
                def function5():
                    ...
                    label.pack()
                    label2=Label(roots,text="MISHRA COURIER SERVICE SYSTEM",bd=10,bg="sandy brown",font=('times',24,'bold'),fg="black").place(relx=.24,rely=.06,anchor=CENTER)
    ...
    #=====================6TH PAGE CODE==================================================================================================
                    ...
                    def function6(cnn1):
                        print
                        messagebox.showinfo("CONGRATULATION","YOUR INVOICE IS CREATED")
                        roots.destroy()
                        final=Tk()
                        icon=PhotoImage(file="bcd3.gif")
                        lab1=Label(final,image=icon)
                        lab1.pack()
                        tlabel=Label(final,text="MISHRA'S COURIER SERVICE SYSTEM",font=('batang',25,'bold'),bd=10,fg="black",bg="sandy brown").place(relx=.26,rely=.08,anchor=CENTER)
                        ...
                        label11=Label(final,text="(SALE'S MANAGER) ",font=('batang',18,'bold'),bd=10,fg="BLACK").place(relx=.80,rely=.78,anchor=CENTER)
                        def fdes():
                            final.destroy()
   ...
   #=====================5TH PAGE CONTINUE=======================================================================================================
                    def fun6():
                        if v1.get()==1:
                            ...
                            z=str(e5.get())
                            a=[u,v,w,x,y,z]
                            cur.execute("insert into shipments values(?,?,?,?,?,?)",a)
                            con.commit()
                        elif v1.get()==2:
                            u='NATIONAL'
                            v=str(e1.get())
    ...
    #====================3RD PAGE CONTINUE====================================================================================================
            ...
            label1=Label(Tops,text="MISHRA'S COURIER SERVICE SYSTEM",bg="light salmon",bd=10,font=('times',30,'bold'), fg="black" ,width=60)
            label1.pack()
...
label4=Label(main,text="ARUSHI MISHRA",font=('arial',22,'bold'),fg="red").place(relx=.15,rely=.3 ,anchor=CENTER)
label5=Label(main,text="171B162",font=('arial',22,'bold'),fg="red").place(relx=.15,rely=.38 ,anchor=CENTER)
label6=Label(main,text="marushi098@gmail.com",font=('arial',20,'bold'),fg="red").place(relx=.15,rely=.46 ,anchor=CENTER)
label7=Label(main,text="07222978513",font=('arial',22,'bold'),fg="red").place(relx=.15,rely=.54 ,anchor=CENTER)
label8=Label(main,text="B5(BY) BATCH",font=('arial',22,'bold'),fg="red").place(relx=.15,rely=.62 ,anchor=CENTER)
main.mainloop()
